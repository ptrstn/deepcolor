...
from . import colorize_image, colornet
from .settings import RESOURCES_PATH
from .utils import load_image

print("%s/1Mio/*.pkl" % RESOURCES_PATH)
for folder in [
    "complete/alt_02_model",
    "complete/alt_03_model",
    "complete/alt_04_model",
    "complete/alt_05_model",
    "complete/alt_06_model",
    "complete/alt_06_02_model",
    "complete/alt_06_03_model",
    "complete/alt_06_04_model",
    "complete/alt_model",
    "complete/model",
    "complete/model_02",
]:
    for model in glob.glob("%s/%s/*.pkl" % (RESOURCES_PATH, folder)):
        ...
        for ext in ["jpg", "png", "jpeg"]:
            for filename in glob.glob("../data/*.%s" % ext):
                ...
                img.save(
                    "../out_data/%s/%s/%s.jpg"
                    % (folder, model_name, os.path.splitext(basename)[0])
                )
