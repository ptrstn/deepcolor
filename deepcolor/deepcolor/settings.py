...
#Zeruniverse
PRETRAINED_PYTORCH_MODEL_DOWNLOAD_URL = "https://github.com/zeruniverse/neural-colorization/releases/download/1.1/G.pth"
PYTORCH_MODEL_DOWNLOAD_URL = "https://raw.githubusercontent.com/zeruniverse/neural-colorization/pytorch/model.py"

PRETRAINED_PYTORCH_MODEL_PATH = Path(RESOURCES_PATH, "model.pth")
PYTORCH_MODEL_PATH = Path(RESOURCES_PATH, "model.py")
